...
namespace wServer.realm
{
    ...
    public class RealmManager
    {
        ...
        {
            "NexusPortal.versus.entity",
            "NexusPortal.versus.player",
            "NexusPortal.versus.guilds"
        };
        // Tableau de nom de realm
        public static List<string> CurrentRealmNames = new List<string>();
        // Maximum de joueur dans un realm
        ...
        public void Initialize()
        {
            ...
            Task.Factory.StartNew(() => GameWorld.AutoName(2, false)).ContinueWith(_ => AddWorld(_.Result), TaskScheduler.Default);
