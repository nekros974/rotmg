    ...
    internal class Program
    {
        ...
        private static void Main(string[] args)
        {
            ...
            Database = new Database(
                Settings.GetValue<string>("db_host", "sql.livehost.fr"),
                Settings.GetValue<string>("db_database", "rotmg_n2up"),
                Settings.GetValue<string>("db_user", "rotmg_n2up"),
                Settings.GetValue<string>("db_auth", "MathieuVincent25"));
